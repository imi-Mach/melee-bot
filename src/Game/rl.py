...
n_actions = 5
# Get the number of state observations(x pos, y pos, self dmg, direction faced, action frame, grounded, offstage, opponent x pos, opponent y pos, opponent dmg)
...
def select_action(state):
    ...
    if sample > eps_threshold:
        ...
        return torch.tensor([[random.choice(list(Actions))]], device=device, dtype=torch.long)
